...
| 5.1  | Applikation ist gestartet. | 1. Ein Spiel starten.<br>2. Auf "Spiel beenden" klicken.<br>3. Den Namen "Biden" eingeben.| Auf der Rangliste sollte ein Eintrag mit dem Namen "Biden" vorhanden sein. |
